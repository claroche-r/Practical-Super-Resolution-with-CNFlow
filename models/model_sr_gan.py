...
class ModelGAN(ModelBase):
    ...
    def optimize_parameters(self, current_step):
        ...
        self.E = self.netG(self.L, self.kernel, self.iso)
        loss_G_total = 0
        ...
        if current_step % self.D_update_ratio == 0 and current_step > self.D_init_iters:  # updata D first
            ...
            elif self.opt['train']['gan_type'] == 'ragan' or 'ragan_mse':
        ...
        elif self.opt['train']['gan_type'] == 'ragan' or self.opt['train']['gan_type'] == 'ragan_mse':
    ...
    def current_visuals(self, need_H=True):
        ...
        out_dict['kernel'] = self.kernel.detach()[0].float().cpu()
        if need_H:
